...
int main()
{
	...
	tree.insert(0, std::make_shared<double>(25.0));
	tree.insert(0, std::make_shared<double>(3.0));
	tree.insert(0, std::make_shared<double>(7.0));
	tree.insert(0, std::make_shared<double>(30.0));
